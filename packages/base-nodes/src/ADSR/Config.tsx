      ...
      <ConfigRow theme={theme}>
        ...
        <ConfigRowControl theme={theme}>
          <ColorInput
            value={colors?.attack}
            onChange={(value) => {
              updateNodeConfig?.({ ...config, colors: { ...colors, attack: value } });
            }}
          />
        </ConfigRowControl>
      </ConfigRow>
      <ConfigRow theme={theme}>
        ...
        <ConfigRowControl theme={theme}>
          <ColorInput
            value={colors?.decay}
            onChange={(value) => {
              updateNodeConfig?.({ ...config, colors: { ...colors, decay: value } });
            }}
          />
        </ConfigRowControl>
      </ConfigRow>
      <ConfigRow theme={theme}>
        ...
        <ConfigRowControl theme={theme}>
          <ColorInput
            ...
            onChange={(value) => {
              updateNodeConfig?.({ ...config, colors: { ...colors, sustain: value } });
            }}
          />
        </ConfigRowControl>
      </ConfigRow>
      <ConfigRow theme={theme}>
        ...
        <ConfigRowControl theme={theme}>
          <ColorInput
            ...
            onChange={(value) => {
              updateNodeConfig?.({ ...config, colors: { ...colors, release: value } });
            }}
          />
        </ConfigRowControl>
      </ConfigRow>
